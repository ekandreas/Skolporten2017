...
<body>
  ...
  <div class="container wrapper">
    ...
    <div class="row">
      ...
      <div class="col-xs-12 col-md-12 col-lg-3">
        ...
        <div class="well">
          ...
          <ul class="nav flex-column">
            <li class="nav-item">
              <a class="nav-link active" href="#">Pressrum</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#">Pressmeddelande</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#">Utmärkelser</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#">Pressbilder</a>
            </li>
          </ul>
      ...
      <div class="col-xs-12 col-md-12 col-lg-8 news-main">
        ...
        <div class="article-short">
          ...
          <div class="article-content">
            ...
            <div class="interview widget well">
