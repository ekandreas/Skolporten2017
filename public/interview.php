        ...
        <div class="article-short">
          ...
          <div class="article-meta">
            <ul class="article-tags">
              <li class="article-tag"><a href="">Intervju</a></li>
            </ul>
            <a href="#" class="article-link" target="_blank">2016-12-19 11:09</a>
            <a href="#" class="article-link" target="_blank"><img src="css/gfx/icon-share.png"/> Dela</a>
            <a href="#" class="article-link" target="_blank"><img src="css/gfx/icon-print.png"/> Skriv ut</a>
          </div>

          <div class="article-content">
            <h2>LO: Förstatliga skolan</h2>
            <p class="lead">Pisa-mätningarna visar att den svenska skolan har blivit mindre likvärdig. Nu uttalar sig LO i frågan och säger att ”ett förstatligande av skolan bör övervägas”.</p>

            <div class="interview widget well col-md-4">
              <h6 class="section-header hidden-xs-down">Faktaruta</h6>
              <img src="../images/interview-image.png"/>

              <dl>
                <dt>Heléne Zetterström Dahlqvist</dt>
                <dd></dd>
                <dt>Född:</dt>
                <dd>1974</dd>
                <dt>Bor:</dt>
